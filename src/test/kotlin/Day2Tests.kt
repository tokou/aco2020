...
class Day2Tests {
    ...
    fun testExamples() {
        val input = """
            ...
            2-9 c: ccccccccc
        """.trimIndent()
        assertEquals(2, input.parsePasswords().count(Password::isValid))
        assertEquals(1, input.parsePasswords().count(Password::isReallyValid))
    }

    @Test
    fun testInput() {
        assertEquals(467, day2.parsePasswords().count(Password::isValid))
        assertEquals(441, day2.parsePasswords().count(Password::isReallyValid))
    }
